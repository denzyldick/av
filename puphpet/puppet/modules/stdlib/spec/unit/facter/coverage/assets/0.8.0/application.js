...
var hljs = new function () {
    ...
    function n(t, y, p) {
        ...
        if (x && x.language) {
            t.dataset.second_best = {language: x.language, kw: x.keyword_count, re: x.r}
        }
    }
...
hljs.LANGUAGES.ruby = function () {
    ...
    var e = {
        ...
        l: g,
        k: n,
        c: [{cN: "title", b: a, l: g, k: n}, {cN: "params", b: "\\(", e: "\\)", l: g, k: n}, d, c, b]
    };
    ...
    m.oPagination = {
        two_button: {
            fnInit: function (g, l, q) {
                ...
                u.className = g.oClasses.sPageNextDisabled;
                ...
                if (g.aanFeatures.p)for (var l =
                    g.aanFeatures.p, q = 0, r = l.length; q < r; q++)if (l[q].childNodes.length !== 0) {
            ...
            fnInit: function (g, l, q) {
                var r = p.createElement("span"), u = p.createElement("span"), y = p.createElement("span"), C = p.createElement("span"), w = p.createElement("span");
                r.innerHTML =
                    g.oLanguage.oPaginate.sFirst;
            ...
            fnUpdate: function (g, l) {
                if (g.aanFeatures.p) {
                    ...
                    for (q = r; q <= w; q++)C += y != q ? '<span class="' + x.sPageButton + '">' + q + "</span>" : '<span class="' + x.sPageButtonActive + '">' + q + "</span>";
                    w = g.aanFeatures.p;
                    var z, D = function () {
                        g._iDisplayStart =
                            (this.innerHTML * 1 - 1) * g._iDisplayLength;
                        l(g);
                        return false
                    }, L = function () {
                        return false
    ...
    j.fn.dataTable = function (g) {
        function l() {
            this.fnRecordsTotal = function () {
                return this.oFeatures.bServerSide ?
                    this._iRecordsTotal : this.aiDisplayMaster.length
            };
            this.fnRecordsDisplay = function () {
                return this.oFeatures.bServerSide ? this._iRecordsDisplay : this.aiDisplay.length
            };
            this.fnDisplayEnd = function () {
                return this.oFeatures.bServerSide ? this.oFeatures.bPaginate === false ? this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iDisplayStart + this.aiDisplay.length) : this._iDisplayEnd
            };
        ...
        function r(a) {
            if (a.bInitialised === false)setTimeout(function () {
                ...
                if (a.sAjaxSource !== null && !a.oFeatures.bServerSide) {
                    K(a, true);
                    a.fnServerData.call(a.oInstance, a.sAjaxSource, null, function (b) {
        ...
        function y(a, b) {
            ...
            if (typeof a.aoPreSearchCols[b] == "undefined" || a.aoPreSearchCols[b] === null)a.aoPreSearchCols[b] = {
                ...
                if (typeof a.aoPreSearchCols[b].bSmart ==
                    "undefined")a.aoPreSearchCols[b].bSmart = true
            }
            C(a, b, null)
        }
        ...
        function C(a, b, c) {
            ...
            if (!b.bSortable ||
                j.inArray("asc", b.asSorting) == -1 && j.inArray("desc", b.asSorting) == -1) {
        ...
        function w(a, b) {
            if (b.length != a.aoColumns.length &&
                a.iDrawError != a.iDraw) {
                J(a, 0, "Added data does not match known number of columns");
                a.iDrawError = a.iDraw;
                return -1
            }
            b = b.slice();
        ...
        function z(a) {
            ...
            if (a.bJUI) {
                b = 0;
                for (d = a.aoColumns.length; b < d; b++)a.aoColumns[b].nTh.insertBefore(p.createElement("span"), a.aoColumns[b].nTh.firstChild)
            }
        ...
        function D(a) {
            ...
            if (typeof a.iInitDisplayStart !=
                "undefined" && a.iInitDisplayStart != -1) {
            ...
            if (!(a.oFeatures.bServerSide && !oa(a))) {
                ...
                c; b++)a.aoDrawCallback[b].fn.call(a.oInstance, a);
                a.bSorted = false;
                a.bFiltered = false
            }
        }
        ...
        function oa(a) {
            if (a.bAjaxDataGet) {
                ...
                c.push({
                    name: "iDisplayLength", value: a.oFeatures.bPaginate !==
                    false ? a._iDisplayLength : -1
                });
        ...
        function pa(a, b) {
            if (typeof b.sEcho != "undefined")if (b.sEcho *
                1 < a.iDraw)return; else a.iDraw = b.sEcho * 1;
            ba(a);
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), f, e, i, h, k, o, t, s = 0; s < d.length; s++) {
                ...
                if (i == "<") {
                    ...
                    if (k == "'" || k == '"') {
                        ...
                        if (o == "H")o = "fg-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix"; else if (o == "F")o = "fg-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
                        h.className = o;
                        s += t
                    }
                    c.appendChild(h);
        ...
        function ua(a) {
            ...
            var b = p.createElement("div"), c = p.createElement("div"), d = p.createElement("div"), f = p.createElement("div"), e = p.createElement("div"), i = p.createElement("div"), h = a.nTable.cloneNode(false), k = a.nTable.cloneNode(false), o = a.nTable.getElementsByTagName("thead")[0], t = a.nTable.getElementsByTagName("tfoot").length ===
            0 ? null : a.nTable.getElementsByTagName("tfoot")[0], s = typeof g.bJQueryUI != "undefined" && g.bJQueryUI ? m.oJUIClasses : m.oStdClasses;
            c.appendChild(d);
            e.appendChild(i);
        ...
        function xa(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0], d = a.nTable.parentNode, f, e, i, h, k, o, t, s, H = [];
            ...
            if (a.oScroll.sX === "") {
                ...
                if (j.browser.msie && j.browser.version <= 7)a.nTable.style.width = v(j(a.nTable).outerWidth() -
                a.oScroll.iBarWidth)
            ...
            if (j(a.nTable).outerWidth() < f)if (a.oScroll.sX === "")J(a,
            ...
            if (a.oScroll.sY === "")if (j.browser.msie &&
        ...
        function P(a, b, c) {
            ...
            for (b = 0; b < a.aoPreSearchCols.length; b++)za(a, a.aoPreSearchCols[b].sSearch, b, a.aoPreSearchCols[b].bRegex,
        ...
        function W(a) {
            ...
            if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
                ...
                if (d.length >= i)for (b = 0; b < i; b++)if (d[b].className.indexOf(e + "1") != -1) {
                    c = 0;
                    for (a = d.length / i; c < a; c++)d[i * c + b].className = d[i * c + b].className.replace(" " +
                    e + "1", "")
                } else if (d[b].className.indexOf(e + "2") != -1) {
                    c = 0;
                    for (a = d.length / i; c < a; c++)d[i * c + b].className = d[i * c + b].className.replace(" " + e + "2", "")
                } else if (d[b].className.indexOf(e + "3") != -1) {
                    c = 0;
                    for (a = d.length / i; c < a; c++)d[i * c + b].className = d[i * c + b].className.replace(" " + e + "3", "")
                }
                h = 1;
                var k;
        ...
        function wa(a) {
            ...
            m.oPagination[a.sPaginationType].fnInit(a,
                b, function (c) {
                    F(c);
                    D(c)
                });
        ...
        function Ca(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                var b = j(a.aanFeatures.i[0]), c = a.fnFormatNumber(a.fnRecordsTotal()), d = a.fnFormatNumber(a._iDisplayStart + 1), f = a.fnFormatNumber(a.fnDisplayEnd()), e = a.fnFormatNumber(a.fnRecordsDisplay());
                if (a.fnRecordsDisplay() === 0 && a.fnRecordsDisplay() == a.fnRecordsTotal())b.html(a.oLanguage.sInfoEmpty + a.oLanguage.sInfoPostFix); else if (a.fnRecordsDisplay() === 0)b.html(a.oLanguage.sInfoEmpty + " " + a.oLanguage.sInfoFiltered.replace("_MAX_", c) + a.oLanguage.sInfoPostFix);
                ...
                if (a.length > 1) {
                    b = b.html();
                    c = 1;
                    for (d = a.length; c < d; c++)j(a[c]).html(b)
                }
            }
        }

        function ra(a) {
            var b = '<select size="1" ' + (a.sTableId === "" ?
                    "" : 'name="' + a.sTableId + '_length"') + ">", c, d;
            ...
            a.sTableId !== "" && typeof a.aanFeatures.l == "undefined" && f.setAttribute("id", a.sTableId +
            "_length");
        ...
        function ea(a) {
            ...
            if (f == i.length && b === 0 && d == f) {
                ...
                e.appendChild(b);
                if (a.oScroll.sX !== "" && a.oScroll.sXInner !== "")b.style.width = v(a.oScroll.sXInner);
                else if (a.oScroll.sX !== "") {
                    b.style.width = "";
                    if (j(b).width() < e.offsetWidth)b.style.width = v(e.offsetWidth)
                } else b.style.width = v(e.offsetWidth);
        ...
        function Fa(a, b) {
            for (var c = 0, d = -1, f = 0; f < a.aoData.length; f++) {
        ...
        function v(a) {
            ...
            if (a.indexOf("entity_manager") != -1 || a.indexOf("%") != -1 || a.indexOf("ex") != -1 || a.indexOf("px") != -1)return a;
            return a + "px"
        }
        ...
        function qa(a, b) {
            b = b.split(",");
            for (var c = [], d = 0, f = a.aoColumns.length; d <
            f; d++)for (var e = 0; e < f; e++)if (a.aoColumns[d].sName == b[e]) {
                c.push(e);
                break
            }
            return c
        ...
        function Ga(a) {
            if (a.oFeatures.bStateSave) {
                ...
                c += '"sFilter": "' + a.oPreviousSearch.sSearch.replace('"', '\\"') + '",';
                ...
                c += "]";
                c += "}";
                Ha(a.sCookiePrefix + a.sInstance, c, a.iCookieDuration, a.sCookiePrefix)
            }
        }
        ...
        function Ia(a, b) {
            if (a.oFeatures.bStateSave) {
                ...
                if (d !== null && d !== "") {
                    try {
                        c =
                            typeof JSON == "object" && typeof JSON.parse == "function" ? JSON.parse(d.replace(/'/g, '"')) : eval("(" + d + ")")
                    } catch (f) {
                        return
                    }
        ...
        function Ha(a, b, c, d) {
            ...
            var e = a + "_" + c.pop().replace(/[\/:]/g, "").toLowerCase();
            b = e + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("/") + "/";
            f = "";
            a = 9999999999999;
            var i;
            if ((ka(e) !== null ? p.cookie.length : b.length +
                p.cookie.length) + 10 > 4096) {
                e = p.cookie.split(";");
                for (var h = 0, k = e.length; h < k; h++)if (e[h].indexOf(d) != -1) {
                    var o = e[h].split("=");
                    try {
                    ...
                    if (typeof i.iCreate != "undefined" && i.iCreate < a) {
                        f = o[0];
                        a = i.iCreate
                    }
                }
        ...
        function ca(a) {
            ...
            for (i = a.length; d < i; d++) {
                ...
                var s = 0, H = [];
                f = 0;
                for (h = a[d].childNodes.length; f < h; f++)if (a[d].childNodes[f].nodeName.toUpperCase() ==
                    "TD" || a[d].childNodes[f].nodeName.toUpperCase() == "TH")H.push(a[d].childNodes[f]);
                f = 0;
                for (h = H.length; f < h; f++) {
                    var I = H[f].getAttribute("colspan") * 1, A = H[f].getAttribute("rowspan") * 1;
                    if (!I || I === 0 || I === 1) {
                        k = o(b, d, s);
            ...
            d = 0;
            for (i = b[0].length; d < i; d++) {
                f = 0;
                for (h = b.length; f < h; f++)typeof b[f][d] == "object" && c.push(b[f][d])
            }
            return c
        }
        ...
        function M(a, b, c) {
            for (var d = 0, f = b.length; d < f; d++)for (var e = 0, i = b[d].childNodes.length; e < i; e++)if (b[d].childNodes[e].nodeType == 1)typeof c != "undefined" ?
                a(b[d].childNodes[e], c[d].childNodes[e]) : a(b[d].childNodes[e])
        }
            ...
            if (c.aoColumns[a].bVisible != b) {
                ...
                if (b) {
                    ...
                    if (b >= T(c)) {
                        ...
                        for (f = c.aoData.length; d < f; d++) {
                            e = c.aoData[d]._anHidden[a];
                            c.aoData[d].nTr.insertBefore(e,
                                j(">td:eq(" + i + ")", c.aoData[d].nTr)[0])
                        }
                    }
        ...
        this.fnDestroy = function () {
            var a = B(this[m.iApiIndex]),
                b = a.nTableWrapper.parentNode, c = a.nTBody, d;
            ...
            } else j("th", a.nTHead).removeClass([m.oStdClasses.sSortable, m.oStdClasses.sSortableAsc, m.oStdClasses.sSortableDesc,
                m.oStdClasses.sSortableNone].join(" "));
            b.appendChild(a.nTable);
            b = 0;
            for (d = a.aoData.length; b < d; b++)c.appendChild(a.aoData[b].nTr);
            j(">tr:even", c).addClass(a.asDestoryStrips[0]);
            j(">tr:odd", c).addClass(a.asDestoryStrips[1]);
            b = 0;
            for (d = E.length; b < d; b++)E[b] == a && E.splice(b, 1)
        };
        ...
        return this.each(function () {
            ...
            for (b = E.length; a < b; a++) {
                if (E[a].nTable == this)if (typeof g == "undefined" || typeof g.bRetrieve != "undefined" && g.bRetrieve === true)return E[a].oInstance; else if (typeof g.bDestroy != "undefined" &&
                    g.bDestroy === true) {
            ...
            if (typeof g != "undefined" && g !== null) {
                ...
                if (e.oScroll.sX !==
                    "" || e.oScroll.sY !== "")e.oScroll.iBarWidth = Ja();
                ...
                if (typeof g.oLanguage != "undefined")if (typeof g.oLanguage.sUrl !=
                    "undefined" && g.oLanguage.sUrl !== "") {
            ...
            if (c) {
                e.asDestoryStrips = ["", ""];
                if (j(d[0]).hasClass(e.oClasses.sStripOdd))e.asDestoryStrips[0] +=
            ...
            for (b = e.aaSorting.length; a < b; a++) {
                ...
                if (typeof g.aaSorting == "undefined" && typeof e.saved_aaSorting == "undefined")e.aaSorting[a][1] = f.asSorting[0];
                c = 0;
                for (d = f.asSorting.length; c < d; c++)if (e.aaSorting[a][1] ==
                    f.asSorting[c]) {
                    e.aaSorting[a][2] = c;
                    break
                }
